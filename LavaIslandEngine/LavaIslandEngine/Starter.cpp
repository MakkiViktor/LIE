...
int main (){
	...
	VK::SwapChain swapChain (windowSurface, logicalDevice);
	VK::ImageViews imageViews (swapChain);
	VK::RenderPass renderPass(swapChain);{
	VK::Pipeline pipeline ( {VK::ShaderDetails ("Shaders/vert.spv",VK_SHADER_STAGE_VERTEX_BIT),
							VK::ShaderDetails ("Shaders/frag.spv",VK_SHADER_STAGE_FRAGMENT_BIT)},
							swapChain, renderPass);

	VK::FrameBuffers frameBuffers(imageViews, renderPass);
	VK::CommandPool commandPool(logicalDevice);
	VK::CommandBuffers commandBuffers(commandPool, pipeline, frameBuffers);
